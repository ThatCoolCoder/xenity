...
public class ResumingAudio : AudioStreamPlayer
{
	...
	[Export] private string profileName = "default";

	private static Dictionary<string, float> playbackPositions = new Dictionary<string, float>();

	public override void _EnterTree()
	{
		if (playbackPositions.ContainsKey(profileName)) Seek(playbackPositions[profileName]);
	}
